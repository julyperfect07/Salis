...
export default async function ProductsPage() { const t = await getTranslations("ShopOwner"); return <DashboardShell title={t("products.pageTitle")} description={t("products.pageDescription")} contentClassName="max-w-6xl"><div className="[&>div>div:first-child]:border-0 [&>div>div:first-child]:bg-transparent [&>div>div:first-child]:p-0 [&>div>div:first-child]:shadow-none"><ProductsManagement /></div></DashboardShell>; }
