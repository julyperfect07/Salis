                ...
                {data.orders.map((order) => (
                  <TableRow key={order.id} className="hover:bg-primary/[0.035]">
                    ...
                    <TableCell className="font-medium">
                      {formatMoney(order.customerTotal)}
                    </TableCell>
                    ...
                    <TableCell className="text-end">
                      <Link
                        ...
                        className="inline-flex h-9 items-center rounded-full border px-4 text-sm font-medium hover:border-primary/30 hover:bg-primary/5 hover:text-primary"
                      >
                        {t("actions.view")}
                      </Link>
                    </TableCell>
