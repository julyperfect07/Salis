...
export function OrderDetails({ orderId }: OrderDetailsProps) {
  ...
  return <div className="space-y-4">
    ...
    {order.customerLatitude && order.customerLongitude && <Button variant="outline" className="rounded-full" render={<a href={getGoogleMapsDirectionsUrl(order.customerLatitude, order.customerLongitude)} target="_blank" rel="noreferrer"/>}><MapPin className="size-4"/>Google Maps</Button>}
