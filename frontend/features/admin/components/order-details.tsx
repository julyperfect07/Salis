  ...
  return (
    <div className="space-y-4">
      <Link
        ...
        className="inline-flex h-10 items-center gap-2 rounded-full border bg-background px-4 text-sm font-medium hover:border-primary/30 hover:bg-primary/5 hover:text-primary"
      >
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex gap-2">
              ...
              <Badge variant="secondary" className="rounded-full">
                {t(`payments.${order.paymentStatus}`)}
              </Badge>
            </div>
          </div>
        </CardHeader>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <Card className="rounded-3xl">
          <CardHeader>
            <CardTitle>{t("details.fulfillment")}</CardTitle>
          </CardHeader>
          <CardContent className="grid gap-3 sm:grid-cols-2">
            ...
            <Detail
              ...
              value={
                order.deliveryCompany?.user.name ?? t("details.notAssigned")
              }
            />
            <Detail
              ...
              value={
                <span className="flex items-center gap-2">
                  ...
                  {order.driver?.user.name ?? t("details.notAssigned")}
                </span>
              }
            />
            <Detail
              label={t("details.note")}
              value={order.customerNote || t("details.none")}
            />
          </CardContent>
        </Card>
        <Card className="rounded-3xl">
          <CardHeader>
            <CardTitle>{t("details.financials")}</CardTitle>
          </CardHeader>
          <CardContent className="grid gap-3 sm:grid-cols-2">
            <Detail
              label={t("details.productsTotal")}
            ...
            />
            <Detail
              label={t("details.shopCommission")}
              value={money(order.shopCommission)}
            />
            <Detail
